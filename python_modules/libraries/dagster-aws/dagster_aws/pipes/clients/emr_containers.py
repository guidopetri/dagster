...
class PipesEMRContainersClient(PipesClient, TreatAsResourceParam):
    ...
    Args:
        ...
        message_reader (Optional[PipesMessageReader]): A message reader to use to read messages
            from the AWS EMR containers workload. Defaults to :py:class:`PipesCloudWatchMessageReader`.
        ...
        poll_interval (float): The interval in seconds to poll the AWS EMR containers workload for status updates. Defaults to 5 seconds.
    ...
    def _wait_for_completion(
        ...
        waiter = self.client.get_waiter("job_run_complete")
    ...
    #     context: Union[OpExecutionContext, AssetExecutionContext],
    #     session: PipesSession,
    #     response: "DescribeJobRunResponseTypeDef",
    #     monitoring_configuration: Optional["MonitoringConfigurationTypeDef"] = None,
    # ):
    #     virtual_cluster_id = cast(str, response["jobRun"].get("virtualClusterId"))
