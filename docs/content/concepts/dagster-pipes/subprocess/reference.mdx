...
ENOENT: no such file or directory, open '/Users/christopherdecarolis/dagster/examples/docs_snippets/docs_snippets/guides/dagster/dagster_pipes/subprocess/rich_metadata/table_metadata.py'
```

#### Table Schema Metadata

```python file=/guides/dagster/dagster_pipes/subprocess/rich_metadata/table_schema_metadata.py
ENOENT: no such file or directory, open '/Users/christopherdecarolis/dagster/examples/docs_snippets/docs_snippets/guides/dagster/dagster_pipes/subprocess/rich_metadata/table_schema_metadata.py'
```

#### Table Column Lineage Metadata

```python file=/guides/dagster/dagster_pipes/subprocess/rich_metadata/table_column_lineage_metadata.py
ENOENT: no such file or directory, open '/Users/christopherdecarolis/dagster/examples/docs_snippets/docs_snippets/guides/dagster/dagster_pipes/subprocess/rich_metadata/table_column_lineage_metadata.py'
```
